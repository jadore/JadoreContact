...
public class HomeDialAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.detail_btn = (TextView) convertView.findViewById(R.id.detail_btn);
			holder.call_log_dialer = (LinearLayout) convertView.findViewById(R.id.call_log_dialer);
		...
		addViewListener(holder.call_log_dialer, clb, position);
