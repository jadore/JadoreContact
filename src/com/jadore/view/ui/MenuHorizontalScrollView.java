...
import com.jadore.view.other.SizeCallBack;
import com.jadore.view.other.SystemScreenInfo;
...
public class MenuHorizontalScrollView extends HorizontalScrollView {
	...
	private void init(){
		this.setHorizontalFadingEdgeEnabled(false);// 设置view在水平滚动时，水平边是否淡出。
		this.setVerticalFadingEdgeEnabled(false);// 设置view在垂直滚动时，垂直边是否淡出。
		this.me = this;
